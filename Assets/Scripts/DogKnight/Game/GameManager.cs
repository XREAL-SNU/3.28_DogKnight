...
public class GameManager : MonoBehaviour, Subject
{
    ...
    public void TurnNotify()
    {
        ...
        // 2. _uiHandler 호출
        _uiHandler(_gameRound, _whoseTurn, false);
    }
    ...
    public void EndNotify()
    {
        ...
        // 2. _uiHandler 호출
        _uiHandler(_gameRound, _whoseTurn, true);
    ...
    {
        foreach(KeyValuePair<string,Character> character in _characterList)
        {
            if(character.Key == name)
            {
