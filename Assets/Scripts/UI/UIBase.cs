...
namespace XReal.XTown.UI
{
    public abstract class UIBase : MonoBehaviour
    {
        ...
        protected GameObject GetObject(int idx) { return GetUIComponent<GameObject>(idx); } // ������Ʈ�μ� ��������
        protected Text GetText(int idx) { return GetUIComponent<Text>(idx); } // Text�μ� ��������
        protected Button GetButton(int idx) { return GetUIComponent<Button>(idx); } // Button�μ� ��������
        protected Image GetImage(int idx) { return GetUIComponent<Image>(idx); } // Image�μ� ��������
