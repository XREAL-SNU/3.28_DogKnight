...
public class Inventory : UIPopup
{
    ...
    public override void Init()
    {
        ...
        GameObject ItemPanel = UIUtils.FindUIChild(gameObject, "ItemPanel", true);
        foreach (string typeName in Enum.GetNames(typeof(ItemPropertyType)))
        {
            ItemGroup _itemGroup = UIManager.UI.MakeSubItem<ItemGroup>(ItemPanel.transform, "ItemGroup");
